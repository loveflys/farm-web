  ...
  export default {
    ...
    methods: {
      getData () {
        ...
        store.getManager(param, (msg)=> {
          if (msg.code === '0') {
            if (msg.manager.avatar&&msg.manager.avatar.length > 0) {
              this.showupload = false;
            }
            this.formValidate = {
              id: msg.manager.id,
              login: msg.manager.login,
              phone: msg.manager.phone,
              pwd: '',
              name: msg.manager.name,
              realName: msg.manager.realName,
              avatar: msg.manager.avatar,
              sex: msg.manager.sex + '',  // 1男 2女
              type: msg.manager.type, // 3普通管理员 4超级管理员
              ciphertext: ''
            };
          } else {
      ...
      editData () {
        ...
        store.updateManager(this.formValidate, (msg)=> {
