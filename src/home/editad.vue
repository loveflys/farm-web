        ...
        store.getAd(param, (msg)=> {
          if (msg.code === '0') {
            ...
            this.formValidate = {
              ...
              title: msg.ad.title,
              type: msg.ad.type,
              responseType: msg.ad.responseType,
              showType: msg.ad.showType,
              content: msg.ad.content,
              img: msg.ad.img,
              showEndTime: new Date(msg.ad.showEndTime),
              showStartTime: new Date(msg.ad.showStartTime),
              url: msg.ad.url
            };
          } else {
            this.$Message.error('获取广告信息失败!', 1 , function () {
